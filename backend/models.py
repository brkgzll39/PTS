...
class BildirimAyarlari(Base):
    ...
    tetikleyici = Column(String(30), default="hepsi")  # hepsi | yetkisiz | kara_liste | suresi_dolmus | supheli_arac | bariyer_hatasi | disk_hatasi | kamera_arizasi | yedek_bozuk | disk_doluyor
